...
var bgPrimary = '#e27d7f',//used
   ...
   bgInfo = '#eba75f',//used
   bgInfoL = '#42a5f5',//used
   bgInfoLr = '#3bafda',//used
   bgInfoD = '#78cdf4',//used
   bgInfoDr = '#547abb',//used
   bgWarning = '#f6bb42',
   bgWarningL = '#cf7251',//used
   bgWarningLr = '#f9d283',
   bgWarningD = '#f4af22',
   bgWarningDr = '#d9950a',
   bgDanger = '#e9573f',
   bgDangerL = '#ffc841',//used
   bgDangerLr = '#f08c7c',
   bgDangerD = '#e63c21',
   bgDangerDr = '#cd3117',
   bgAlert = '#967adc',
   ...
   bgAlertDr = '#6c44ce',
   bgSystem = '#37bc9b',
   bgSystemL = '#655277',//used
   bgSystemLr = '#b4c1d7',//used
   bgSystemD = '#2fa285',
   bgSystemDr = '#288770',
   bgLight = '#f3f6f7',
   bgLightL = '#fdfefe',
