...
var demoHighCharts = function () {
        ...
        var demoHighColumns = function () {
            ...
            if (column1.length) {
                ...
                $('#high-column').highcharts({
                    credits: false,
                    colors: [bgInfoDr, bgInfoD, bgInfoL, bgLightCrimson,
                        bgDanger, bgSuccess, bgSystem, bgDark
                    ],
                    chart: {
        ...
        var demoHighAreas = function () {
            ...
            if (area1.length) {
                ...
                $('#high-area').highcharts({
                    colors: [bgInfo, bgDanger, bgInfoLr],
                    credits: false,
                    chart: {
                        type: 'areaspline',
                        spacing: 0,
    ...
    var sparkColors = {
        ...
        "twilight": [bgTwilight, bgTwilight, bgTwilight],
        "smalt": [bgSmalt, bgSmalt, bgSmalt, bgSmalt],
        ...
        if (infoCircle.length) {
            ...
            infoCircle.each(function (i, e) {
                ...
                var circle = Circles.create({
                    ...
                    value: $(e).attr('value'),
                    radius: $(e).width() / 2,
                    width: $(e).attr('width') || 20,
                    colors: color,
                    text: function (value) {
                        var title = $(e).attr('title'),
                            show = $(e).attr('value-show'),
                            tag = $(e).attr('tag') || 'h2';
                        if (title) {
                            if (show) {
